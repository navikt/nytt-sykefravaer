...
const TidslinjeElement = ({
  ...
  return (
    <div className="tidslinje-element">
      ...
      {!erForsteElement && !erSisteElement && (
        <div className="tidslinje-element tidslinje-element__linje"></div>
      )}
      ...
      <div className="tidslinje-element tidslinje-element__stegindikator">
        ...
        {!erEkspanderbar && !erForsteElement && (
          <img src={klokke} alt="klokkeikon" width={25} />
        )}
      </div>
      ...
      {erEkspanderbar ? (
        <div
          ref={panelRef}
          className="tidslinje-element tidslinje-element__ekspanderbar"
        >
          <Ekspanderbartpanel
