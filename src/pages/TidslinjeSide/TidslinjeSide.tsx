  ...
  return (
    <div className="limit">
      ...
      <Tekstomrade className="infoheader">
        På tidslinjen ser du hva som forventes av deg i løpet av sykefraværet.
        Oppgavene kan gjøres på andre tidspunkter hvis det er behov for det.
        Hvis du er for syk til å delta i jobb eller aktivitet, kan du få unntak
        fra enkelte av oppgavene
      </Tekstomrade>
          ...
          label={
            <div className="arbeidssituasjon__uten-arbeidsgiver-label">
              ...
              <Hjelpetekst className="arbeidssituasjon__hjelpetekst">
                Velg «Jeg har ikke arbeidsgiver» dersom du er for eks.
                selvstendig næringsdrivende, frilanser eller arbeidsledig.
              </Hjelpetekst>
            </div>
          }
          name="arbeidssituasjon"
