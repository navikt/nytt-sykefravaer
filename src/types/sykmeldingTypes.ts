...
class ArbeidsrelatertArsak {
  ...
  constructor(arbeidsrelatertArsak: any) {
    ...
    const arsakTemp = arbeidsrelatertArsak.arsak.map(
      (arsak: any) =>
        ArbeidsrelatertArsakType[arsak as keyof typeof ArbeidsrelatertArsakType]
    );
    this.arsak = arsakTemp;
  }
}
...
export class ErIArbeid {
  ...
  constructor(erIArbeid: any) {
    ...
    this.arbeidFOM = erIArbeid.arbeidFOM
      ? dayjs(erIArbeid.arbeidFOM).toDate()
      : undefined;
    this.vurderingsdato = erIArbeid.vurderingsdato
      ? dayjs(erIArbeid.vurderingsdato).toDate()
      : undefined;
  }
}
...
export class ErIkkeIArbeid {
  ...
  constructor(erIkkeIArbeid: any) {
    ...
    this.arbeidsforFOM = erIkkeIArbeid.arbeidsforFOM
      ? dayjs(erIkkeIArbeid.arbeidsforFOM).toDate()
      : undefined;
    this.vurderingsdato = erIkkeIArbeid.vurderingsdato
      ? dayjs(erIkkeIArbeid.vurderingsdato).toDate()
      : undefined;
  }
}
...
class KontaktMedPasient {
  ...
  constructor(kontaktMedPasient: any) {
    this.kontaktDato = kontaktMedPasient.kontaktDato
      ? dayjs(kontaktMedPasient.kontaktDato).toDate()
      : undefined;
...
export class Sykmelding {
  ...
  constructor(sykmelding: any) {
    ...
    this.medisinskVurdering = new MedisinskVurdering(
    ...
    Object.keys(sykmelding.utdypendeOpplysninger).forEach(key => {
      ...
      Object.keys(sykmelding.utdypendeOpplysninger[key]).forEach(key2 => {
        opplysning.set(
          key2,
          new SporsmalSvar(sykmelding.utdypendeOpplysninger[key][key2])
        );
      });
    ...
    this.meldingTilNAV = sykmelding.meldingTilNAV
      ? new MeldingTilNAV(sykmelding.meldingTilNAV)
      : undefined;
...
export class SykmeldingDTO {
  ...
  constructor(sykmeldingDTO: any) {
    ...
    this.bekreftetDato = sykmeldingDTO.bekreftetDato
      ? dayjs(sykmeldingDTO.bekreftetDato).toDate()
      : undefined;
    this.behandlingsutfall = new BehandlingsutfallDTO(
      sykmeldingDTO.behandlingsutfall
    );
    this.legekontorOrgnummer = sykmeldingDTO.legekontorOrgnummer
      ? sykmeldingDTO.legekontorOrgnummer
      : undefined;
    this.legeNavn = sykmeldingDTO.legeNavn ? sykmeldingDTO.legeNavn : undefined;
    this.arbeidsgiver = sykmeldingDTO.arbeidsgiver
      ? new ArbeidsgiverDTO(sykmeldingDTO.arbeidsgiver)
      : undefined;
...
export class SkjermetSykmeldingDTO {
  ...
  constructor(skjermetSykmeldingDTO: any) {
    ...
    this.bekreftetDato = skjermetSykmeldingDTO.bekreftetDato
      ...
      : undefined;
    this.behandlingsutfall = new BehandlingsutfallDTO(
      skjermetSykmeldingDTO.behandlingsutfall
    );
    this.legekontorOrgnummer = skjermetSykmeldingDTO.legekontorOrgnummer
      ? skjermetSykmeldingDTO.legekontorOrgnummer
      : undefined;
    this.legeNavn = skjermetSykmeldingDTO.legeNavn
      ? skjermetSykmeldingDTO.legeNavn
      : undefined;
...
export class FullstendigSykmeldingDTO {
  ...
  constructor(fullstendigSykmeldingDTO: any) {
    ...
    this.bekreftetDato = fullstendigSykmeldingDTO.bekreftetDato
      ...
      : undefined;
    this.behandlingsutfall = new BehandlingsutfallDTO(
      fullstendigSykmeldingDTO.behandlingsutfall
    );
    this.legekontorOrgnummer = fullstendigSykmeldingDTO.legekontorOrgnummer
      ? fullstendigSykmeldingDTO.legekontorOrgnummer
      : undefined;
    this.legeNavn = fullstendigSykmeldingDTO.legeNavn
      ? fullstendigSykmeldingDTO.legeNavn
      : undefined;
    ...
    this.medisinskVurdering = new MedisinskVurdering(
      fullstendigSykmeldingDTO.medisinskVurdering
    );
  }
}
...
class BehandlingsutfallDTO {
  ...
  constructor(behandlingsutfallDTO: any) {
    this.ruleHits = behandlingsutfallDTO.ruleHits.map(
      (regel: RegelinfoDTO) => new RegelinfoDTO(regel)
    );
    this.status =
      BehandlingsutfallStatusDTO[
        behandlingsutfallDTO.status as keyof typeof BehandlingsutfallStatusDTO
      ];
  }
}
...
class RegelinfoDTO {
  ...
  constructor(regelinfoDTO: any) {
    ...
    this.ruleStatus = regelinfoDTO.ruleStatus
      ? BehandlingsutfallStatusDTO[
          regelinfoDTO.status as keyof typeof BehandlingsutfallStatusDTO
        ]
      : undefined;
  }
}
...
class ArbeidsgiverDTO {
  ...
  constructor(arbeidsgiverDTO: any) {
    ...
    this.stillingsprosent = arbeidsgiverDTO.stillingsprosent
      ? arbeidsgiverDTO.stillingsprosent
      : undefined;
  }
}
...
class SykmeldingsperiodeDTO {
  ...
  constructor(sykmeldingsperiodeDTO: any) {
    ...
    this.gradert = sykmeldingsperiodeDTO.gradert
      ? new GradertDTO(sykmeldingsperiodeDTO.gradert)
      : undefined;
    ...
    this.innspillTilArbeidsgiver = sykmeldingsperiodeDTO.innspillTilArbeidsgiver
      ...
      : undefined;
    this.type =
      PeriodetypeDTO[sykmeldingsperiodeDTO.type as keyof typeof PeriodetypeDTO];
  }
}
